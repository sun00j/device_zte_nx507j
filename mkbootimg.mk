...
MSM8974_DTS_FILE = $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/msm8974pro-ab-pm8941-mtp-NX507J.dts
MSM8974_DTS_FILENAME = msm8974pro-ab-pm8941-mtp-NX507J.dts
DTB_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/,$(patsubst %.dts,%.dtb,$(MSM8974_DTS_FILENAME)))
ZIMG_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/,$(patsubst %.dts,%-zImage,$(MSM8974_DTS_FILENAME)))
